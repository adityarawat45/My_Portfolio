...
export const Box3 = ({text,img}) => {
  return (
    <div className={`py-1 px-2.5 md:py-2 md:px-5 w-fit bg-lime-700 border-r-4 border-b-4 border-lime-900 rounded-b-lg rounded-tr-md rounded-t-lg rounded-l-lg`}>
       <div className='flex flex-row justify-evenly gap-1 md:gap-4 items-center text-sm md:text-lg font-bold font-mono  text-slate-950'><div>{img}</div> <div>{text}</div> </div>
    </div>
  )
}
export const Box4 = ({text,img}) => {
  return (
    <div className={`py-1 px-2.5 md:py-2 md:px-5 w-fit bg-red-800 border-r-4 border-b-4 border-red-900 rounded-b-lg rounded-r-lg rounded-t-lg rounded-l-lg`}>
       <div className='flex flex-row justify-evenly gap-1 md:gap-4 items-center text-sm md:text-lg  font-bold font-mono  text-slate-950'><div>{img}</div> <div>{text}</div> </div>
    </div>
  )
}
