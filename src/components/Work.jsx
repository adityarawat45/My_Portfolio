...
const Work = () => {
  return (
    <div className='flex justify-center items-center'>
        ...
        {/* Technosoft */}
        {<WorkTemplate profile={"Backend Developer Intern"} org={"AX Technosoft"} Location={"Gurugram"} mode={"On-Site"} start={"Sept, 2024"} end={"Current"}
        pointOne={"Integrated many CRM and ERP apps like Odoo, Quickbooks and Twilio. Including connectors with auth, rest apis and many other customization from scratch."}
        pointTwo={"Implemented the complete functionality of deleting an entity with an improved time complexity of 0(n) with the use of a hashmap."}
