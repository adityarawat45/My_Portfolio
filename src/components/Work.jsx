...
const Work = () => {
  return (
    <div className='flex justify-center items-center'>
        ...
        {/* Aonflow */}
        {<WorkTemplate profile={"Software Engineer"} org={"Aonflow"} Location={"Gurugram"} mode={"On-Site"} start={"Sept, 2024"} end={"Jan, 2026"}
        ...
        ></WorkTemplate>}
        {/* CRPTM */}
        {<WorkTemplate profile={"Backend Engineer"} org={"CRPTM"} Location={"Gurugram"} mode={"On-Site"} start={"Aug, 2025"} end={"Jan, 2026"}
