...
const Work = () => {
  return (
    <div className='flex justify-center items-center'>
        ...
        {/* Aonflow */}
        {<WorkTemplate profile={"Backend Developer Intern"} org={"Aonflow"} Location={"Gurugram"} mode={"On-Site"} start={"Sept, 2024"} end={"July, 2025"}
        pointOne={"Engineered and maintained backend functionality for Aonflow, an iPaaS (integration platform as a service)."}
        pointTwo={"Integrated many CRM and ERP apps like Odoo, Quickbooks and Twilio. Including connectors with auth, rest apis and many other customization from scratch."}
        pointThree={"Worked on different app and flow router apis, and contributed by resolving various bugs."}
        ></WorkTemplate>}
        {/* CRPTM */}
        {<WorkTemplate profile={"SDE Backend"} org={"CRPTM"} Location={"Gurugram"} mode={"On-Site"} start={"Aug, 2025"} end={"July, Current"}
