...
export const SmallNav = () => {
    return (
        <div className="w-screen fixed z-10 bg-green-950  bg-opacity-30 border-b-2  flex border-green-700 justify-center items-center">
            <nav className="w-full flex items-center backdrop-blur-sm  justify-between text-green-50 px-3 py-2">
                <motion.div
